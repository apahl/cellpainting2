...
d = {
    ...
    "ACT_CUTOFF_PERC_REF_H": ACT_CUTOFF_PERC_REF_H, "ACT_CUTOFF_PERC_H": ACT_CUTOFF_PERC_H,
...
<br>
<br>
<h3>Parameter Heatmaps</h3>
<p>Heatmaps of Log2-fold parameter values for $Well_Id and its most similar references (if similar references were found).<br>
<p>See <a href="#log2fold">below</a> for a description of how the Log2-fold values are calculated.</p>
$Heatmap
<br>
<br>
<h3>Images</h3>
...
<br>
<br>
<h3>List of Parameters and Their Log2-Fold Values (Compared to Control)</h3>
<p id="log2fold">The parameter values are calculated as Log2-fold values of a modified z-score
in the following way:</p>
<p>For each parameter the Median and MAD of the controls are calculated.<br>
The Log2-fold value of a compound‘s measured parameter value is then calculated to be the Log2 of how many times the MAD the measured value derives from the controls:</p>
    <p>
        <math display="block">
            <semantics>
                <mrow>
                            ...
                            <mfrac>
                                <mrow>
                                    ...
                                    <msub>
                                        ...
                                        <mi mathvariant="italic">Controls</mi>
                                    </msub>
                                </mrow>
                                <msub>
                ...
                <annotation encoding="StarMath 5.0">Log2fold = log_2 ( {value_{Cpd.} - Median_Controls} over {MAD_Controls} )</annotation>
            </semantics>
        </math>
    </p>
<p>
...
d = {"TABLE_INTRO": TABLE_INTRO, "TABLE_EXTRO": TABLE_EXTRO,
     ...
     "PARM_TABLE_HEADER": PARM_TABLE_HEADER}
